...
global function KateAeroAutopilotTask {
    local this is KateCyclicTask("KateAeroAutopilotTask", "ATPLT", 0.01).
    ...
    this:override("uiContent", KateAeroAutopilotTask_uiContent@).
    
    this:def("onActivate", KateAeroAutopilotTask_onActivate@).
    this:def("onDeactivate", KateAeroAutopilotTask_onDeactivate@).
    this:def("onCyclic", KateAeroAutopilotTask_onCyclic@).
    this:def("setAfterburners", KateAeroAutopilotTask_setAfterburners@).
    this:def("setAutopilotParameters", KateAeroAutopilotTask_setAfterburners@).
...
local function KateAeroAutopilotTask_onActivate {
    parameter this.
...
local function KateAeroAutopilotTask_onDeactivate {
    parameter this.
...
local function KateAeroAutopilotTask_uiContent {
    parameter this.
...
local function KateAeroAutopilotTask_onCyclic {
    parameter this.
...
local function KateAeroAutopilotTask_setAfterburners {
